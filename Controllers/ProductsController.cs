...
//********************************************************
// 方法命名開頭加入Http verb : Get/Head/Post/Put/Delete/Connect/Options/Patch
/// <summary>
...
public class ProductsController : ControllerBase
{
    ...
    {
        new() { Id = 1, Name = "Tomato Soup", Category = "Groceries", Price = 1 },
        new() { Id = 2, Name = "Yo-yo", Category = "Toys", Price = 3.75M },
        new() { Id = 3, Name = "Hammer", Category = "Hardware", Price = 16.99M },
        new() { Id = 4, Name = "張中文", Category = "Toys", Price = 5 },
        new() { Id = 5, Name = "李法文", Category = "Hardware", Price = 6M },
        new() { Id = 6, Name = "許功蓋(PHP)", Category = "Groceries", Price = 7 }
    };
